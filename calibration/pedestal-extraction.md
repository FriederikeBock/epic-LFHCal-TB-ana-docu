...
A basic calibration script has been prepared. Similar to the [Converter-scripts](../tb-analysis-basics/converting-the-data.md#caen-data-conversion) please add your user name and respective data location respectively.
...
```sh
bash runHGCROCCalibration_TBPST10_2026.sh $USERNAME pedestal [Ref|Muon|Electron|Test]
```
