...
# TB 2025: Getting Started HGCROC & Calibrations
...
The software to configure the HGCROC is called `H2GConfig` (see [link](../hgcroc-setup-test-beam/setting-up-daq-pc.md#software-installation) for details where to find it). This can be started as follows:
...
To test whether the KCUs are reachable use the `Ping FPGA` button, if that does not work check your network configuration and follow the steps laid out in [link](../hgcroc-setup-test-beam/setting-up-daq-pc.md#setup-network).
...
The calibration is handled and steered using `H2GCalib_3B` package ([link](../hgcroc-setup-test-beam/setting-up-daq-pc.md#software-installation)). Its workflow is as follows.

<figure><img src="../.gitbook/assets/Screenshot at 2025-11-07 11-48-32.png" alt=""><figcaption></figcaption></figure>
...
<div><figure><img src="../.gitbook/assets/UI_Start_2.png" alt=""><figcaption></figcaption></figure> <figure><img src="../.gitbook/assets/UI_FPGA_2.png" alt=""><figcaption></figcaption></figure></div>
